...
class CaptchaChallenge(Base):
    ...
    solution_raw = Column(JSON, nullable=True)
    captcha_context_id = Column(Text, nullable=True)
    captcha_context_id_empty = Column(Boolean, nullable=False, default=False)
    retried_with_empty_context = Column(Boolean, nullable=False, default=False)
    error = Column(Text, nullable=True)
